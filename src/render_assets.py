        ...
        with open(filename, 'r', encoding="utf-8") as lines:
            while True:
                ...
                for line in lines:
                    ...
                    prefixs = ['Radius', 'Disabled', 'Inactive', 'Default', 'Widget', 'Window', 'Selection', 'Tooltip', 'View', 'WM']
...
parser.add_argument('--gtk2-dir', '-g', action='store', default='gtk2', help='location of gtk2 directory to define the color ' 'scheme variables')
parser.add_argument('--gtk3-scss-dir', '-G', action='store', default='.', help='location of global.scss to define the color ' 'scheme variables')
...
#button_bg = Color(_colors, 'WidgetBackgroundNormal')
#button_fg = Color(_colors, 'WidgetForegroundNormal')
#button_hover = Color(_colors, 'WidgetBackgroundHover')
#button_active = Color(_colors, 'WidgetBackgroundActive')
